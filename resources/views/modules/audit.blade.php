...
<div id="view-audit" class="view-panel">
    ...
    <div class="stagger-1" style="display:flex; justify-content:space-between; align-items:center; background:var(--card-bg); border:1px solid var(--border-subtle); padding:0.85rem 1rem; border-radius:6px; margin-bottom:1.25rem; flex-wrap:wrap; gap:10px;">
        ...
        <div style="display:flex; gap:6px;">
            ...
            <button class="btn btn-sm" onclick="printDocument('AUDIT-2026-07', 'auditLog')"><i class="fa-solid fa-download"></i> Export Audit Log</button>
        </div>
    </div>

    <!-- System Audit Activity Log Stream -->
    <div class="card stagger-2">
        ...
        <div class="card-body">
            <div class="terminal-box" style="height:320px; cursor:pointer;" onclick="document.getElementById('jsonDiffModal').classList.add('open')"><span class="hl-orange">[2026-07-25 12:45:10 UTC]</span> USER: adminRAAX (ID: e1000000) | ACTION: JournalEntry.Posted | IP: 127.0.0.1
  BEFORE: {"status": "draft", "amount_cents": 4500000}
  AFTER:  {"status": "posted", "amount_cents": 4500000, "hash": "31af3d709ad29613..."}

<span class="hl-green">[2026-07-25 12:30:22 UTC]</span> USER: adminRAAX (ID: e1000000) | ACTION: SalesOrder.Confirmed | IP: 127.0.0.1
