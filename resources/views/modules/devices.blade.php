...
<div id="view-telemetry" class="view-panel">
    ...
    <div class="stagger-1" style="display:grid; grid-template-columns: 1fr 1fr; gap:1rem; margin-bottom:1.25rem;">
        <div style="background:var(--card-bg); border:1px solid var(--border-subtle); padding:0.85rem 1rem; border-radius:6px; display:flex; align-items:center; justify-content:space-between;">
            ...
            <button class="btn btn-sm" onclick="printDocument('ESC-POS-TEST', 'posReceipt')"><i class="fa-solid fa-print"></i> Test Print Receipt</button>
        </div>
        ...
        <div style="background:var(--card-bg); border:1px solid var(--border-subtle); padding:0.85rem 1rem; border-radius:6px; display:flex; align-items:center; justify-content:space-between;">
            ...
            <button class="btn btn-outline btn-sm" onclick="document.getElementById('barcodeListenerModal').classList.add('open')"><i class="fa-solid fa-barcode"></i> Listen Scanner</button>
        </div>
    </div>
