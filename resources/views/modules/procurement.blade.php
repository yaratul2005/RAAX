...
<div id="view-procurement" class="view-panel">
    ...
    <div style="background:var(--card-bg); border:1px solid var(--border-subtle); border-radius:6px; padding:0.85rem 1rem; margin-bottom:1.25rem; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px;">
        <div>
        ...
        <div style="display:flex; gap:6px;">
            <button class="btn btn-outline btn-sm" onclick="showToast('Running 3-way match validation across PO, GRN, and Vendor Invoice...')"><i class="fa-solid fa-magnifying-glass"></i> 3-Way Match Check</button>
