...
- **API & Contract Boundaries:** Inter-module communication must take place via registered service contracts (defined under `app/Contracts/` or within the module's `Contracts/` dir) or asynchronously by dispatching domain events via Horizon queues.
