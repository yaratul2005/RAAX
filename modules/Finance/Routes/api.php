...
Route::middleware(['api', 'tenant'])->prefix('api/v1')->group(function () {
    ...
    Route::post('/finance/bank/statements/{statementId}/reconcile', [\Modules\Finance\Http\Controllers\BankReconciliationController::class, 'reconcile']);
    Route::get('/finance/bank/statements/{statementId}/unmatched', [\Modules\Finance\Http\Controllers\BankReconciliationController::class, 'unmatched']);
